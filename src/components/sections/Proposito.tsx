        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg text-left transform hover:-translate-y-2 transition-transform duration-300">
            ...
            <p className="text-gray-600">
              Contribuir com a manutenção da limpeza, ordem e vigilância e zelar 
              pela tranquilidade do Distrito Recanto Maestro (SJP).
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg text-left transform hover:-translate-y-2 transition-transform duration-300">
            ...
            <p className="text-gray-600">
              Harmonia com a natureza, responsabilidade com o bem público 
