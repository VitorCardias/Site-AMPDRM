  ...
  return (
    ...
    >
      <div className="relative">
        {/* Círculo com ícone do WhatsApp */}
        <div className="bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-2xl transition-all duration-300 transform group-hover:scale-110 flex items-center justify-center w-14 h-14 md:w-16 md:h-16">
          <svg
